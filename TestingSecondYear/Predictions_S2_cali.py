...
# ---------- calibration residuals (realistic; available before test/future) ----------
S2_calib_results = val_data_S2.copy()
S2_calib_results["predicted"] = val_pred
S2_calib_results["residual_raw"] = S2_calib_results["n"] - S2_calib_results["predicted"]
